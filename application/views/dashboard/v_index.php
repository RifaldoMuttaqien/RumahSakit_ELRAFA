...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url(); ?>" class="logo">
                <span class="logo-mini"><b>Rumah Sakit</b></span>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" datatoggle="dropdown">
                                <img src="<?php echo base_url(); ?>assets3/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                                <span class="hidden-xs">HAK AKSES :
                                    <b><?php echo $this->session->userdata('level') ?></b></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="<?php echo base_url(); ?>assets3/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                    <p>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="header">Rumah Sakit Back End</li>
                    <li>
    ...
    <script src="<?php echo base_url(); ?>assets3/bower_components/jquery-ui/jqueryui.min.js"></script>
    <script>
        $.widget.bridge('uibutton', $.ui.button);
    </script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/raphael/raphael.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/morris.js/morris.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/jquerysparkline/dist/jquery.sparkline.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/plugins/jvectormap/jquery-jvectormap1.2.2.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/plugins/jvectormap/jquery-jvectormap-world-millen.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/jqueryknob/dist/jquery.knob.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/moment/min/moment.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/bootstrapdaterangepicker/daterangepicker.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/bootstrapdatepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/jqueryslimscroll/jquery.slimscroll.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/bower_components/fastclick/lib/fastclick.js"></script>
    <script src="<?php echo base_url(); ?>assets3/dist/js/adminlte.min.js"></script>
    <script src="<?php echo base_url(); ?>assets3/dist/js/pages/dashboard.js"></script>
